  ...
  <body>
    ...
    <div class="container">
      <ul class="nav nav-pills m-0 p-0">
        <li class="nav-item p-2 font-11 text-center">
            <label class="switch">
        ...
        <li class="nav-item p-2 font-11 text-center">
            <label class="switch">
                ...
                <span class="slider round"></span>
            </label><label for="viewCovidEjc">Covid-19</label>
        </li>
        <li class="nav-item p-2 font-11 text-center">
            <label class="switch">
                <input type="checkbox" class="primary layer_switch" value="heatgarbagemap" id="viewHeatgarbagemap">
                <span class="slider round"></span>
            </label><label for="viewHeatgarbagemap">Area de Impacto</label>
        </li>
      </ul>
      <div class="row">
                ...
                res.data.forEach(function (paciente){              
                  ...
                  if(paciente.tipo == 'Positivo' && paciente.situacion == 'Domicilio'){
                    ...
                    marker.addListener('click', function() {                    
                        ...
                        '<div class="row mt-2 mx-1 pt-2">'+
                        '   <div class="col-10 text-left">'+
                        '       Paciente: <strong>'+ paciente.nombreapellido+'</strong>'+
                        '   </div>'+
                        '   <div class="col-2 p-0 text-center">'+
                        '       <img src="http://localhost:8080/static/images/garbageconaitner-'+paciente.company+'.svg" width="32" height="32">'+
                        '   </div>'+
                        '</div>'    
